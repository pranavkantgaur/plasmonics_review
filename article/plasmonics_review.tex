...
Ti$_3$C$_2$T$_x$ & NIR--Mid-IR & Hydrophilic, 2D morphology &
  High (solution) \\
Graphene & THz--Mid-IR & Extreme confinement ($\lambda/300$), gate-tunable (see Sect.~\ref{sec:vdw}) &
  Moderate (transfer) \\
\bottomrule
\end{tabularx}
\end{table}
...
misleading for quantitative sensor design~\cite{leru2007surface}.
Systematic characterisation of the
